...
export function ChaosTicker({ symbol, price, change }: { symbol: string; price: string; change: string }) {
  return (
    <div className="cm-ticker grid grid-cols-3 gap-3 border-b border-border px-4 py-3 font-mono text-xs tabular last:border-b-0">
      <span className="cm-ticker__symbol">{symbol}</span>
