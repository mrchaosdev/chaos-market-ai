    ...
    <main className="cm-landing relative min-h-screen bg-background text-foreground">
      ...
      <div className="cm-landing__frame relative min-h-screen">
        <section className="cm-landing__content flex min-h-screen flex-col">
          ...
          <div className="cm-landing-header border-b border-border sm:pl-[70px]" data-market-header>
            <div className="cm-landing-header__grid grid gap-px bg-border md:grid-cols-[1fr_420px]">
              <div className="cm-landing-header__identity flex items-center bg-background/95 px-5 py-5 lg:px-8">
                <div className="cm-landing-header__copy">
                  <p className="cm-landing-header__eyebrow font-mono text-[11px] uppercase tracking-[0.24em] text-muted-foreground">
                    Binance Agent OS Mini Hackathon / Read Only Intelligence
                  </p>
                  <h1 className="cm-landing-header__title mt-2 text-2xl font-semibold tracking-tight md:text-3xl">Chaos Market AI</h1>
                </div>
              </div>
              <div className="cm-landing-header__metrics grid grid-cols-3 gap-px bg-border">
